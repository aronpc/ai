---
name: @devops/cicd
command: /aronpc:devops:cicd
description: CI/CD com GitHub Actions, Docker e deploy automatizado
version: 1.0.0
author: aronpc
license: MIT
category: devops
...
|-------|-------------------|
| `@gh/workflow` | Para integrar com branches e commits |
| `@quality/qa` | Para pipelines de qualidade |
| `@laravel/testing` | Para pipelines de teste |
| `@quality/docs` | Para atualizar docs pós-deploy |
