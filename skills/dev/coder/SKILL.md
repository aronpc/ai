...
|-------|-------------------|
| `@plan/planner` | Para usar planos estruturados como input |
| `@plan/sprint` | Para executar tarefas de um sprint |
| `@laravel/architecture` | Para seguir padrões arquiteturais |
| `@laravel/standards` | Para seguir padrões de código |
| `@laravel/testing` | Para criar testes durante implementação |
| `@quality/qa` | Para validação final do código |
| `@gh/workflow` | Para commits atômicos |
