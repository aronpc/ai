...
|-------|-------------------|
| `@plan/spec` | Para criar specs técnicas das features do sprint |
| `@plan/planner` | Para planejamento técnico com phases e subtasks |
| `@dev/coder` | Para executar as tarefas do sprint |
| `@gh/issues` | Para converter issues em tarefas de sprint |
| `@quality/qa` | Para validar entregas antes de fechar o sprint |
| `@gh/workflow` | Para commits e branches do sprint |
