...
description: Agente implementador de código passo-a-passo com verificação obrigatória e autocrítica. Ideal para transformar planos em código funcional.
license: MIT
compatibility: Requer ambiente de desenvolvimento com git e ferramentas de teste
metadata:
  author: Auto Claude
  version: 1.0.0
