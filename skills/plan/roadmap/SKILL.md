...
|-------|-------------------|
| `@plan/spec` | Para transformar features do roadmap em specs técnicas |
| `@plan/sprint` | Para criar sprints a partir do roadmap |
| `@ideation/codebase` | Para descobrir melhorias técnicas |
