...
|-------|-------------------|
| `@quality/qa` | Para validação completa de qualidade |
| `@dev/coder` | Para criar testes durante implementação |
| `@laravel/architecture` | Para testar Actions e Policies |
| `@laravel/models` | Para criar Factories e testar Models |
| `@devops/cicd` | Para pipelines de teste |
| `@gh/pr-review` | Para verificar cobertura em PRs |
