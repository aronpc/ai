...
|-------|-------------------|
| `@plan/sprint` | Para documentar progresso do sprint |
| `@dev/coder` | Para atualizar docs pós-implementação |
| `@devops/cicd` | Para atualizar docs pós-deploy |
| `@plan/spec` | Para criar specs a partir de docs |
