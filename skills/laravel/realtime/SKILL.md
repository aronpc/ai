...
|-------|-------------------|
| `@laravel/actions` | Para broadcasting de events |
| `@laravel/testing` | Para testar WebSockets |
| `@devops/mcp` | Para validar realtime no browser |
| `@devops/cicd` | Para deploy com Reverb |
