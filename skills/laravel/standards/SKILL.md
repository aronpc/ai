...
|-------|-------------------|
| `@dev/coder` | Para seguir padrões durante implementação |
| `@gh/pr-review` | Para verificar aderência em reviews |
| `@quality/qa` | Para validação de estilo |
| `@gh/workflow` | Para pre-commit hooks |
