...
|-------|-------------------|
| `@plan/spec` | Para converter issues válidos em specs |
| `@plan/sprint` | Para adicionar issues a sprints |
| `@plan/planner` | Para planejar implementação de bugs |
| `@gh/pr-review` | Para relacionar issues com PRs |
