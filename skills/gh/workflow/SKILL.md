...
|-------|-------------------|
| `@dev/coder` | Para commits após implementação |
| `@plan/sprint` | Para commits de tarefas do sprint |
| `@gh/pr-review` | Para preparar PRs bem estruturados |
| `@devops/cicd` | Para triggers de CI/CD |
| `@laravel/standards` | Para pre-commit hooks |
