...
|-------|-------------------|
| `@dev/coder` | Para implementar seguindo a arquitetura |
| `@laravel/actions` | Para Actions, Events e Jobs |
| `@laravel/models` | Para Models e relações |
| `@laravel/exceptions` | Para exceções de domínio |
| `@laravel/testing` | Para testar Actions e Policies |
| `@plan/planner` | Para planejar arquitetura de features |
