...
|-------|-------------------|
| `@quality/qa` | Para validação de qualidade antes do review |
| `@laravel/standards` | Para verificar aderência aos padrões |
| `@gh/workflow` | Para verificar convenções de commit |
