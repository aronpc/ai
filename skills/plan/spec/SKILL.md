...
|-------|-------------------|
| `@plan/roadmap` | Para usar features do roadmap como input |
| `@ideation/codebase` | Para descobrir melhorias baseadas no código |
| `@ideation/ui-ux` | Para descobrir melhorias de interface |
| `@plan/planner` | Para transformar spec em plano de implementação |
| `@plan/sprint` | Para criar sprint a partir da spec |
| `@gh/issues` | Para converter issues em requisitos |
